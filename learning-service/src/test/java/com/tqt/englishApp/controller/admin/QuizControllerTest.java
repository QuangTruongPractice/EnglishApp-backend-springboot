...
public class QuizControllerTest {
        ...
        void listQuizs_WithoutParams_Success() throws Exception {
                Page<QuizDetailResponse> page = new PageImpl<>(Collections.emptyList(), PageRequest.of(0, 8), 0);
                when(quizService.getQuizzesAdmin(anyMap())).thenReturn(page);
        ...
        void listQuizs_WithParams_Success() throws Exception {
                ...
                verify(quizService)
                                .getQuizzesAdmin(
                                                argThat(params -> "What".equals(params.get("question"))
        ...
        void updateQuizs_Success() throws Exception {
                when(quizService.getQuizById(anyInt())).thenReturn(new QuizDetailResponse());
