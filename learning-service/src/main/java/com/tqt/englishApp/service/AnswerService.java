...
public class AnswerService {
    ...
    public AnswerResponse getAnswerById(Integer id) {
        return answerMapper.toAnswerResponse(
                answerRepository.findById(id).orElseThrow(() -> new AppException(ErrorCode.ANSWER_NOT_EXISTED)));
    }

    public AnswerRequest getAnswerRequestById(Integer id) {
        return answerMapper.toAnswerRequest(
                answerRepository.findById(id).orElseThrow(() -> new AppException(ErrorCode.ANSWER_NOT_EXISTED)));
    }
