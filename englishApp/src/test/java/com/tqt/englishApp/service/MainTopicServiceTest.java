...
class MainTopicServiceTest {
    ...
    MainTopic mainTopic;
    MainTopicResponse mainTopicResponse;
    ...
    void init() {
        ...
        mainTopicResponse = new MainTopicResponse();
    ...
    void createMainTopic_Success() throws IOException {
        MainTopicRequest req = new MainTopicRequest(1, "Topic 1", image, null);
        ...
        when(mainTopicMapper.toMainTopicResponse(any(MainTopic.class))).thenReturn(mainTopicResponse);

        MainTopicResponse result = mainTopicService.createMainTopic(req);
    ...
    void createMainTopic_Fail_ImageRequired() {
        MainTopicRequest req = new MainTopicRequest(1, "Topic 1", null, null);
    ...
    void createMainTopic_Fail_ImageEmpty() {
        MainTopicRequest req = new MainTopicRequest(1, "Topic", image, null);
    ...
    void updateMainTopic_Success_WithImage() throws IOException {
        MainTopicRequest req = new MainTopicRequest(1, "Updated Topic", image, null);
        ...
        MainTopicResponse result = mainTopicService.updateMainTopic(1, req);
    ...
    void updateMainTopic_Success_NoImage() {
        MainTopicRequest req = new MainTopicRequest(1, "Updated Topic", null, null);
        when(mainTopicRepository.findById(1)).thenReturn(Optional.of(mainTopic));
        when(mainTopicRepository.save(any())).thenReturn(mainTopic);
        when(mainTopicMapper.toMainTopicResponse(any(MainTopic.class))).thenReturn(mainTopicResponse);
    ...
    void updateMainTopic_Fail_NotFound() {
        MainTopicRequest req = new MainTopicRequest(1, "F", image, null);
    ...
    void getMainTopics_WithKeyword() {
        ...
        Page<MainTopicResponse> result = mainTopicService.getMainTopics(params);
    ...
    void getMainTopics_NegativePage_ReturnsFirstPage() {
        ...
        mainTopicService.getMainTopics(params);
    ...
    void getMainTopicById_Success() {
        when(mainTopicRepository.findById(1)).thenReturn(Optional.of(mainTopic));
        when(mainTopicMapper.toMainTopicResponse(mainTopic)).thenReturn(mainTopicResponse);

        MainTopicResponse result = mainTopicService.getMainTopicById(1);
    ...
    void getMainTopicById_Fail_NotFound() {
        ...
        AppException ex = assertThrows(AppException.class, () -> mainTopicService.getMainTopicById(99));
        assertEquals(ErrorCode.TOPIC_NOT_EXISTED, ex.getErrorCode());
    }
    ...
    void findAll_Success() {
        ...
        when(mainTopicMapper.toMainTopicResponse(anyList())).thenReturn(List.of(mainTopicResponse));

        List<MainTopicResponse> result = mainTopicService.findAll();
