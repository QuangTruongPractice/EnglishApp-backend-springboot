...
class SubTopicServiceTest {
    ...
    void init() {
        ...
        subTopicResponse = new SubTopicResponse();
    ...
    void createSubTopic_Success() {
        ...
        when(subTopicMapper.toSubTopicResponse(any(SubTopic.class))).thenReturn(subTopicResponse);

        SubTopicResponse result = subTopicService.createSubTopic(req);
    ...
    void updateSubTopic_Success() {
        ...
        SubTopicResponse result = subTopicService.updateSubTopic(1, req);
    ...
    void getSubTopics_WithKeyword() {
        ...
        Page<SubTopicResponse> result = subTopicService.getSubTopics(params);
    ...
    @Test
    void getSubTopicById_Success() {
        when(subTopicRepository.findById(1)).thenReturn(Optional.of(subTopic));
        when(subTopicMapper.toSubTopicResponse(subTopic)).thenReturn(subTopicResponse);

        SubTopicResponse result = subTopicService.getSubTopicById(1);
    ...
    @Test
    void getSubTopicById_Fail_NotFound() {
        when(subTopicRepository.findById(99)).thenReturn(Optional.empty());

        AppException ex = assertThrows(AppException.class, () -> subTopicService.getSubTopicById(99));
        assertEquals(ErrorCode.TOPIC_NOT_EXISTED, ex.getErrorCode());
    }
    ...
    void findAll_Success() {
        ...
        when(subTopicMapper.toSubTopicResponse(anyList())).thenReturn(List.of(subTopicResponse));

        List<SubTopicResponse> result = subTopicService.findAll();
    ...
    void deleteSubTopic_Success() {
        ...
        verify(subTopicRepository).deleteVocabularySubTopicRelations(1);
