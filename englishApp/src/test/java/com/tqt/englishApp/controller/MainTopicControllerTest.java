...
public class MainTopicControllerTest {
    ...
    void listTopics_WithoutParams_Success() throws Exception {
        Page<MainTopicResponse> page = new PageImpl<>(Collections.emptyList(), PageRequest.of(0, 10), 0);
    ...
    void listTopics_WithParams_Success() throws Exception {
        ...
        verify(mainTopicService)
                .getMainTopics(argThat(params -> "Test".equals(params.get("name")) && "2".equals(params.get("page"))));
    }
    ...
    void updateTopics_Success() throws Exception {
        when(mainTopicService.getMainTopicById(anyInt())).thenReturn(new MainTopicResponse());
