...
public class UserControllerTest {
    ...
    void listUsers_WithKeyword_Success() throws Exception {
        ...
        verify(userService)
                .getUsers(argThat(params -> "test".equals(params.get("keyword")) && "1".equals(params.get("page"))));
    }
    ...
    void listUsers_WithoutKeyword_Success() throws Exception {
        ...
        verify(userService)
                .getUsers(argThat(params -> !params.containsKey("keyword") && "1".equals(params.get("page"))));
    }
